...
class Test_User_Profile_Class:
    ...
    def test_CredKart_Title_001(self):
        ...
        if self.driver.title == "CredKart":
            ...
            self.driver.save_screenshot(r"E:\Automation testing\04.CredKart_Pytest_Framework\Screenshots\User login Successfully.png")
            allure.attach.file(r"E:\Automation testing\04.CredKart_Pytest_Framework\Screenshots\User login Successfully.png", name="User login Successfully", attachment_type=allure.attachment_type.PNG)
            assert True
        else:
            self.log.info("Landed on incorrect page and it's title is: " + self.driver.title)
            self.log.info("Taking screenshot")
            self.driver.save_screenshot(r"E:\Automation testing\04.CredKart_Pytest_Framework\Screenshots\User login Failed.png")
    ...
    def test_CredKart_Registration_003(self):
        ...
        if self.rp.verify_menu() == "Pass":
            ...
            self.driver.save_screenshot(
                r"E:\Automation testing\04.CredKart_Pytest_Framework\Screenshots\User Registration Failed.png")
            assert False
        self.log.info("Testcase test_CredKart_Login_002 is completed\n")
